      ...
      <div className="body-container">
        <div className="body-item">
          <div className="body-header">
            &nbsp;
            <span className="blue-words">2022 겨울학기</span> 수강신청 기간 안내
            &nbsp;&nbsp;
            <span className="gray-words">※ 장바구니는 선착순이 아닙니다.</span>
          </div>
        ...
        <div className="body-item">
          ...
          <div className="body-article">
            * 2022학년도 2학기에 수강중인 교과목을 동계 계절수업에 바로
            수강신청할 경우,
            <br />
            수강신청 내역 취소처리 또는 성적상의 불이익(재수강 미인정, 동일과목
            성적 중복 인정)이 발생할 수 있습니다.
            <br />
            <br />
        ...
        {!loginState && (
          <div className="manual-box">
            <a href="https://now.snu.ac.kr/popup/card/37">
              <div className="blue-box">장바구니 초보를 위한 수강신청 안내</div>
            </a>
