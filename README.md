...
* 회원가입 및 로그인
  - snu 메일을 통한 소셜 로그인 기능을 제공하였습니다. 자동 로그아웃 기능을 지원합니다.
...
* 수강평, 댓글 
  - 강좌에 별점과 수강평을 입력하고 그에 대한 댓글을 달 수 있습니다. 글쓴이는 익명으로 처리됩니다. 수강평에 따른 강의평가(5점 만점)는 강좌 상세정보에서 확인 가능합니다.
...
* 수강신청 기간 변경
  - 수강 신청 기간을 pre-semester, cart, cart-confirmation, registration, semester 5구간으로 나누고 state를 데이터베이스에 저장한 뒤 기간에 따라 permission을 제한하여 사용할 수 있는 기능을 구분하였습니다. custom command(changeperiod)와 cron job을 이용하여 기간을 자동으로 변경할 수 있도록 하였습니다.
* 강좌 제한
- 시간표, 장바구니에 강좌를 담을 때 시간대가 겹치거나 동일한 강좌인 경우, 신청 가능 학점 수를 초과하는 경우 강좌를 더 이상 추가할 수 없도록 제한하였습니다.
* 프론트엔드 개발 과정
